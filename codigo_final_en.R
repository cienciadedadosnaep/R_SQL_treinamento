...
#    ggplot(aes(x=grupo,y = quantitativog1,fill=grupo))+
    ...
    xlab("")+
    ylab("%")+
    labs(caption = "Source: Data Science in Public Education Program")+
    ggtitle("Data Science Exam")+
    ...
    scale_color_manual(name="Guide",values=c("#303600","#a5c500" ,"#d4c78c","#5ec6f2","003468"),
                       labels = c("Excellent","Very good","good","regular","Did not meet expectations"))+
    ylim(0, 100)
  #  bbc_style()
  ggsave('figuras/boxplot_G1_QUANT_CD_QUALI_CD_en.png')
  ...
  dadoscd2022 %>% 
    ...
    ylim(0, 100)
#    bbc_style()
  ggsave('figuras/boxplot_G2_QUANT_CD_QUALI_CD_en.png')
